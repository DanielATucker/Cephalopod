...
export class MusicPlayer extends Component {
  ...
  playPause(event) {
    ...
    let audio1 = new Audio("https://https://${process.env.host}:5001:5001/vidChunk?id=failed_state");
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div>
                        ...
                        id="audio1"
                        controls
                        src="https://https://${process.env.host}:5001:5001/vidChunk?id=failed_state"
