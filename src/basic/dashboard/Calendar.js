...
class Calendar1 extends React.Component {
  ...
  getCalendarData = () => {
    axios
      .get(`http://${process.env.host}/calendar/get_events`)
      .then((returned) => {
  ...
  refreshData(action, eventItem) {
    switch (action) {
      case "update":
        axios
          .post(`http://${process.env.host}/calendar/update_event`, {
      ...
      case "insert":
        axios
          .post(`http://${process.env.host}/calendar/insert_event`, {
            eventData: eventItem.item,
            eventTitle: eventItem.item.label,
          })
          .then(function (result) {
      ...
      case "delete":
        axios
          .post(`http://${process.env.host}/calendar/delete_event`, {
            eventData: eventItem.item,
            eventTitle: eventItem.item.label,
          })
          .then(function (result) {
