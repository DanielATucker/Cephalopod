...
export class Kanban1 extends Component {
  ...
  taskAdd(event) {
    ...
    fetch(
      `https://http://${process.env.host}/Kanban/task_add`,
      {
        method: "POST",
        mode: "cors",
        headers: {
  ...
  taskUpdate(event) {
    ...
    fetch(
      `https://http://${process.env.host}/Kanban/task_update`,
      {
        method: "POST",
        mode: "cors",
        headers: {
  ...
  taskRemoved(event) {
    ...
    fetch(
      `https://http://${process.env.host}/Kanban/task_remove`,
      {
        method: "POST",
        mode: "cors",
        headers: {
  ...
  columnAdd(event) {
    ...
    fetch(
      `https://http://${process.env.host}/Kanban/column_add`,
      {
        method: "POST",
        mode: "cors",
        headers: {
  ...
  columnUpdate(event) {
    ...
    fetch(
      `https://http://${process.env.host}/Kanban/column_update`,
      {
        method: "POST",
        mode: "cors",
        headers: {
  ...
  columnRemoved(event) {
    ...
    fetch(
      `https://http://${process.env.host}/Kanban/column_removed`,
      {
        method: "POST",
        mode: "cors",
        headers: {
