...
export default class BookmarkManager {
     ...
     * @returns {void}
    */
    updateBookmarks(database: string, previousBookmarks: Iterable<string>, newBookmarks: Iterable<string>): Promise<void>;
    /**
     ...
     */
    getBookmarks(database: string): Promise<Iterable<string>>;
    /**
     ...
     * @returns {Iterable<string>} The set of bookmarks
     */
    getAllBookmarks(): Promise<Iterable<string>>;
    /**
     ...
     */
    forget(databases: Iterable<string>): Promise<void>;
}
