...
class journal_handler:
    ...
    @sio.event
    def body(sio, username, User_list, journal_body):
    ...
    @sio.event
    def title(sio, username, User_list, journal_title):
    ...
    @sio.event
    def Etitle(sio, username, User_list, journal_title, journal_body, mood, anxiety, depression, energy):
